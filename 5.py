...
@traceable(name="5.py - Chat Session")
...
Remember the conversation context and refer back to previous questions when relevant.""",
        name="5.py - Chat with Memory"
    )
    
    print("=" * 60)
    print("Welcome to the AI Shopping Assistant with Memory!")
    print("Ask me about products, prices, availability, and more.")
    print("I'll remember our conversation, so you can ask follow-up questions.")
